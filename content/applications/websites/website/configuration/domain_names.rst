...
difficult-to-remember numerical IP addresses that are difficult to remember into readable, memorable web addresses.
...
#. :ref:`Map the domain name to your Odoo website <domain-name/existing/website-map>`.
...
.. note::
   ...
   - :ref:`Map your subdomain name to your Odoo database <domain-name/existing/db-map>`.
   - :ref:`Map your subdomain name to you website <domain-name/existing/website-map>`.
...
Using subdomains allows you to use a single domain name for :doc:`multiple websites
<multi_website>`. To do so:
