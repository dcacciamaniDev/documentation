...
On the form, enter all required information. The business address **must** be exactly the same as it
...
.. important::
    ...
    and unit numbers. Mismatches may cause synchronization to fail or the listing not to appear on
    Google.
